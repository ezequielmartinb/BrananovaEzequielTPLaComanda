...
class Mesa
{
    ...
    public function modificarMesa()
    {
        ...
        $consulta = $objAccesoDato->prepararConsulta("UPDATE Mesas SET idPedido = :idPedido, codigoMesa = :codigoMesa, idMozoAsignado = :idMozoAsignado, estado = :estado WHERE id = :id");
